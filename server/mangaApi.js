...
async function getWrongAnswers(count, excludeTitle) {
    const wrongAnswer = [];
    let attempts = 0;
...
async function getChapterServer(chapterId) {
    try {
...
async function getChapterScanlation(chapterId) {
    try {
...
async function getScanlationGroup(groupId) {
